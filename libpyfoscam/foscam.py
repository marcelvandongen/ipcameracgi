...
class FoscamCamera(object):
    ...
    def send_command(self, cmd, params=None, raw=False):
        ...
        cmdurl = 'http://%s/%s?user=%s&pwd=%s%s' % ( self.url,
                                                         cmd,
                                                         self.usr,
                                                         self.pwd,
                                                         paramstr)
...
#            root = ET.fromstring(raw_string.decode('utf-8'))
        except:
            if self.verbose:
...
#                params[child.tag] = unquote(child.text)
        ...
        if raw_string == 'ok':
            code = FOSCAM_SUCCESS
        if raw_string == 'error: illegal param':
        	code = ERROR_FOSCAM_FORMAT
        if self.verbose:
    ...
    def set_video_resolution(self, res, callback=None):
        '''
        Set video resolution
        ``res``: 2 qqvga, 8 qvga, 32 vga
        '''
        params = {'param': 0,
                  'value': res
                 }
        return self.execute_command('camera_control.cgi', params, callback=callback)

    def set_video_brightness(self, bright, callback=None):
        '''
        Set video brightness
        ``bright``: 0 low ... 255 high
        '''
        params = {'param': 1,
                  'value': bright
                 }
    ...
    def set_video_mode(self, mode, callback=None):
        '''
        Set video mode
    ...
    def flip_video(self, flip, callback=None):
        '''
        Flip video
        ``flip``: 0 Not flip, 1 Flip hor, 2 flip vert, 3 flip both
        '''
        params = {'param': 5,
                  'value': flip
                 }
    ...
    def set_infra_led_config(self, mode, callback=None):
        ...
        mode: 0=on, 1=blinking, 2=off
        '''
        params = {'led_mode': mode}
        return self.execute_command('set_misc.cgi', params, callback=callback)
    ...
    def get_product_all_info(self, callback=None):
        ...
        '''
        return self.execute_command('get_params.cgi', callback=callback)
    ...
    def ptz_move_up(self, callback=None):
        ...
        return self.execute_command('decoder_control.cgi', params, callback=callback)
    ...
    def ptz_reset(self, callback=None):
        ...
        '''
        params = {'command': 25}
        return self.execute_command('decoder_control.cgi', callback=callback)
    ...
    def ptz_set_preset(self, preset_num=1, callback=None):
        """ Sets the PZT to the non-volatile preset indicated
    ...
    def ptz_goto_preset(self, preset_num=1, callback=None):
    ...
    def start_patrol(self, vert=False, horiz=False):
        """
        :param vert: Setting to True enables vertical patrol mode
    ...
    def stop_patrol(self, vert=False, horiz=False):
        """
        :param vert: Setting to True stops vertical patrol mode
    ...
    def snap_picture_2(self, callback=None):
        ...
        cmd: snapshot.cgi
        '''
        return self.execute_command('snapshot.cgi', {}, callback=callback, raw=True)
